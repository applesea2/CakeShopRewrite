...
}: Partial<OrderNotificationEmailProps>) {
    return (
        <Html lang="en">
            <Head />
            <Body style={body}>
                <Container style={container}>
                    ...
                    <Section style={header}>
                        ...
                        <Text style={badge}>New Order Request</Text>
                    </Section>

                    {/* Main content */}
                    <Section style={content}>
                        <Text style={heading}>You've received a new cake order!</Text>

                        <Hr style={divider} />

                        <Text style={sectionHeading}>Customer Details</Text>
                        <Row style={row}>
